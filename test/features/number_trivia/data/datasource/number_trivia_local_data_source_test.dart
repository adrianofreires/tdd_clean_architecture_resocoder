...
void main() {
  ...
  group('getLastNumberTrivia', () {
    ...
    test(
      'deve retornar NumberTrivia do SharedPreferences quando tiver algum no cache',
      () async {
        // arrange
    ...
    test(
      'deve retornar um CacheException quando não tiver algo no cache',
      () async {
        // arrange
  ...
  group('cacheNumberTrivia', () {
    final tNumberTriviaModel =
        NumberTriviaModel(number: 1, text: 'trivia test');
    test(
      'deverá chamra o SharedPreferences para o cache do data ',
      () async {
        // act
