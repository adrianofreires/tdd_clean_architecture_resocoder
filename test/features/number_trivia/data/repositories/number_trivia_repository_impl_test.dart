...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestsOnline(() {
      ...
      test(
        'deve retornar dados remotos quando a chamada para os dados remotos forem bem sucedidos',
        () async {
          // arrange
      ...
      test(
        'deverá retornar um server failure quando a chamada para os dados remotos não for bem sucedida',
        () async {
          // arrange
    ...
    runTestsOffline(() {
      test(
        'deve retornar o ultimo dado armazenado localmente quando os dados em cache estiverem presentes',
        () async {
          // arrange
      ...
      test(
        'deve retornar CacheFailure quando não tiver dados em cache armazenados',
        () async {
          // arrange
          when(mockLocalDataSource.getLastNumberTrivia())
